...
public class ArangoDbClient implements Serializable {
     ...
     */
    public ArangoDbClient(Properties conf, String database) {
		Validate.notEmpty(conf.getProperty("arangodb.host"), "host can not be blank or null");
        Validate.notEmpty(conf.getProperty("arangodb.port"), "port can not be blank or null");
        Validate.notEmpty(conf.getProperty("arangodb.username"), "username can not be blank or null");
        Validate.notEmpty(conf.getProperty("arangodb.password"), "password can not be blank or null");
        this.HOST = conf.getProperty("arangodb.host");
        this.PORT= Integer.parseInt(conf.getProperty("arangodb.port"));
        this.USERNAME = conf.getProperty("arangodb.username");
        this.PASSWORD = conf.getProperty("arangodb.password");
